...
Función escalón
Permite practicar la implementación modular de funciones y su invocación desde un método principal.

AudioCollage.java

Programa que permite manipular clips de audio y generar una composición ("collage") aplicando operaciones como:
...
Ejercicio inspirado en procesamiento de audio digital básico.
...
Importar la carpeta y permitir que IntelliJ reconozca el proyecto.

3. Ejecutar cada programa

Abrir cualquier archivo .java y ejecutar la función Run.
...
Practicar programación modular en Java

Comprender el diseño de funciones reutilizables

Trabajar con bibliotecas externas (como StdAudio)

Reforzar lógica matemática y procesamiento digital básico
